...
namespace eos
{
    ...
    namespace templates
    {
        ...
        {
            "B->K^*ll::S_9", // A_im is nothing but S_9
            Kinematics{ { "s_min", 1.0 }, { "s_max", 6.0 } },
            Options{ { "q", "d" }, { "l", "mu" }, { "tag", "BFS2004" } },
        ...
        static const MultivariateGaussianConstraintTemplate<19> B_to_Kstar_V_A0_A1_A12_T1_T2_T23_BSZ_2015_lcsrlattice_parameters
        {
            {{
                "B->K^*::alpha^A0_0@BSZ2015",  "B->K^*::alpha^A0_1@BSZ2015",  "B->K^*::alpha^A0_2@BSZ2015",
                "B->K^*::alpha^A1_0@BSZ2015",  "B->K^*::alpha^A1_1@BSZ2015",  "B->K^*::alpha^A1_2@BSZ2015",
                                               "B->K^*::alpha^A12_1@BSZ2015", "B->K^*::alpha^A12_2@BSZ2015",
                "B->K^*::alpha^V_0@BSZ2015",   "B->K^*::alpha^V_1@BSZ2015",   "B->K^*::alpha^V_2@BSZ2015",
                "B->K^*::alpha^T1_0@BSZ2015",  "B->K^*::alpha^T1_1@BSZ2015",  "B->K^*::alpha^T1_2@BSZ2015",
                                               "B->K^*::alpha^T2_1@BSZ2015",  "B->K^*::alpha^T2_2@BSZ2015",
                "B->K^*::alpha^T23_0@BSZ2015", "B->K^*::alpha^T23_1@BSZ2015", "B->K^*::alpha^T23_2@BSZ2015"
            }},
            {{ Kinematics{{ }}, Kinematics{{ }}, Kinematics{{ }},
               Kinematics{{ }}, Kinematics{{ }}, Kinematics{{ }},
               /* A12_0 */      Kinematics{{ }}, Kinematics{{ }},
            ...
            {{
               ...
               Options{}, Options{}, Options{},
               Options{}, Options{}, Options{},
               /*T2_0*/   Options{}, Options{},
               Options{}, Options{}, Options{}
            }},
            {{
                0.369196, -1.365840,  0.128191,
                0.297250,  0.392378,  1.189160,
                /*A_12*/   0.533638,  0.483166,
                0.376313, -1.165970,  2.424430,
                0.312055, -1.008930,  1.527200,
                /*T_2*/    0.496846,  1.614310,
                0.667412,  1.318120,  3.823340
            }},
            {{
                0.0289419, 0.256849,  1.634380,
                0.0263560, 0.187894,  1.025310,
                           0.128772,  0.656273,
                0.0332944, 0.261268,  1.531002,
                0.0275000, 0.189580,  1.639700,
                           0.166220,  0.803780,
                0.0633300, 0.222130,  2.203400
            }},
            {{
                0.0289419, 0.256849,  1.634380,
                0.0263560, 0.187894,  1.025310,
                           0.128772,  0.656273,
                0.0332944, 0.261268,  1.531020,
                0.0275000, 0.189580,  1.639700,
                           0.166220,  0.803780,
                0.0633300, 0.222130,  2.203400
            }},
            ...
            {{
                {{ 1.000000, 0.633689, 0.057531, 0.061537, 0.169044, 0.240647, 0.609495, 0.035503, 0.039332, 0.178168, 0.195421, 0.016488, 0.045264,-0.158457, 0.150264, 0.031155, 0.451075, 0.104911,-0.347452 }},
                {{ 0.045264, 0.448732, 0.674459, 0.681010, 0.760031, 0.400555, 0.234436, 0.402833, 0.716437, 0.906137,-0.078356, 0.713877, 1.000000, 0.000931, 0.881232, 0.365115, 0.601021, 0.427022,-0.210129 }},
                {{-0.158457,-0.182566,-0.125613,-0.468536,-0.373063,-0.127614,-0.060960,-0.077975,-0.400738,-0.236675, 0.338328,-0.473872, 0.000931, 1.000000,-0.239308, 0.626511,-0.270880,-0.105814, 0.447129 }},
                {{ 0.150264, 0.495428, 0.701034, 0.692637, 0.915195, 0.597150, 0.285770, 0.422339, 0.702845, 0.916209,-0.054106, 0.686349, 0.881232,-0.239308, 1.000000, 0.382807, 0.658722, 0.468750,-0.326765 }},
                {{ 0.031155, 0.181197, 0.273928,-0.202092, 0.226359, 0.402339, 0.248484, 0.253397,-0.147198, 0.261192, 0.384930,-0.229853, 0.365115, 0.626511, 0.382807, 1.000000, 0.096936, 0.216438, 0.270390 }},
                {{ 0.451075, 0.573536, 0.663092, 0.564524, 0.695868, 0.553618, 0.386552, 0.403006, 0.573778, 0.702660, 0.016202, 0.515437, 0.601021,-0.270880, 0.658722, 0.096936, 1.000000, 0.327243,-0.711856 }},
                {{ 0.104911, 0.533560, 0.426721, 0.306140, 0.457217, 0.252273, 0.537224, 0.571118, 0.277866, 0.480664, 0.000067, 0.236189, 0.427022,-0.105814, 0.468750, 0.216438, 0.327243, 1.000000, 0.287454 }},
                {{-0.347452,-0.194020,-0.318126,-0.362387,-0.440385,-0.404950,-0.037769,-0.027685,-0.360324,-0.355976, 0.056913,-0.310316,-0.210129, 0.447129,-0.326765, 0.270390,-0.711856, 0.287454, 1.000000 }}
            }},
            0u
        };
         ...
         */
        static const MultivariateGaussianCovarianceConstraintTemplate<48> B_to_Kstar_V_A0_A1_A12_11dot9_to_17dot8_HLMW_2015
        {
       ...
       {{ 3.18713761e-03,   2.68647253e-03,   2.38807642e-03,   2.20559614e-03,   3.18267758e-03,   3.11426858e-03,
         ...
         */
        static const MultivariateGaussianCovarianceConstraintTemplate<22> Lambda_b_to_Lambda_v_a_t_t5_parameters_DM_2016
        {
            {{
...
0.003619965157987, -0.3512302745458, 2.8088303844212, -0.002137591323261, 0.002336940401947, 0.170948236544902, -0.001684398181157, 0.010911341318195, 0.063831820629273, 0.009468286998763, 0.07495950955294 }},
    ...
    make_constraint_factories()
    {
        static const std::map<std::string, ConstraintFactory> constraint_factories =
        {
            ...
            { "B->K^*::V+A_0+A_1+A_12+T_1+T_2+T_23@BSZ2015[LCSR+Lattice]", make_factory(templates::B_to_Kstar_V_A0_A1_A12_T1_T2_T23_BSZ_2015_lcsrlattice_parameters) },
            ...
            { "Lambda_b->Lambda::f_perp+long^V+A+T+T5@DM2016", make_factory(templates::Lambda_b_to_Lambda_v_a_t_t5_parameters_DM_2016) },
        };
