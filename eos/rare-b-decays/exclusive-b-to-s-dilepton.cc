...
namespace eos
{
    ...
    struct Implementation<BToKstarDilepton>
    {
            ...
            tau(p["life_time::B_" + o.get("q", "d")], u)
        {
            ...
            else if ("CFFMPSV2015" == tag)
            {
                amplitude_generator.reset(new BToKstarDileptonAmplitudes<tag::CFFMPSV2015>(p, o));
            }
            else if ("GP2004" == tag)
            {
        ...
        double a_fb_zero_crossing() const
        {
            ...
            WilsonCoefficients<BToS> wc = model->wilson_coefficients_b_to_s(amplitude_generator->lepton_flavour, amplitude_generator->cp_conjugate);
    ...
    BToKstarDilepton::integrated_s_1s(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j1s + a_c_bar.j1s) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_1c(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j1c + a_c_bar.j1c) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_2s(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j2s + a_c_bar.j2s) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_2c(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j2c + a_c_bar.j2c) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_4(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j4 + a_c_bar.j4) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_5(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j5 + a_c_bar.j5) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_6s(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j6s + a_c_bar.j6s) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_7(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j7 + a_c_bar.j7) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
    ...
    BToKstarDilepton::integrated_s_8(const double & s_min, const double & s_max) const
    {
        ...
        return (a_c.j8 + a_c_bar.j8) / (_imp->decay_width(a_c) + _imp->decay_width(a_c_bar));
    }
