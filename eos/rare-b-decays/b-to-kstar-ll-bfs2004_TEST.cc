    ...
    {
        {
            ...
            // all analytical QCDF integrals
            // imaginary part of J_1 is wrong
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_left,  complex<double>(-1.120616135e-10, +5.284362583e-12), eps);
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_right, complex<double>(+4.337275083e-11, +3.519640623e-11), eps);
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_left,  complex<double>(-4.177379962e-11, +1.772537811e-11), eps);
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_right, complex<double>(+5.963768892e-11, +3.724128192e-11), eps);
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_perp_left,  complex<double>(+4.352686602e-11, +3.983777696e-12), eps);
            //TEST_CHECK_RELATIVE_ERROR_C(amps.a_perp_right, complex<double>(+9.326590159e-11, +1.104026119e-10), eps);

            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_left,  complex<double>(-1.120616135e-10, +6.012789469e-12), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_right, complex<double>(+4.331680271e-11, +3.591794269e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_left,  complex<double>(-4.189654575e-11, +1.638207343e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_right, complex<double>(+5.951384172e-11, +3.589797724e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_perp_left,  complex<double>(+4.352686602e-11, +5.240801326e-12), eps);
