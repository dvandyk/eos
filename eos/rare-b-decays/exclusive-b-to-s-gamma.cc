...
namespace eos
{
    ...
    struct Implementation<BToKstarGamma>
    {
        ...
        Amplitudes amplitudes() const
        {
            ...
            QCDFIntegrals<BToKstarDilepton> qcdf_0 = this->qcdf_photon_massless_case(m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
            QCDFIntegrals<BToKstarDilepton> qcdf_c = this->qcdf_photon_charm_case(m_c_pole, m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
            QCDFIntegrals<BToKstarDilepton> qcdf_b = this->qcdf_photon_bottom_case(m_b_PS, m_B, m_Kstar, mu, a_1_perp, a_2_perp, a_1_par, a_2_par);
