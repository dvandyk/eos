...
namespace eos
{
    ...
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::BToKstarDileptonAmplitudes(const Parameters & p, const Options & o) :
        ...
        // parameters for [CFFMPSV2015] for carthesian coordinates
        re_h_00(p["B->K^*ll::Re{h_0^0}@CFFMPSV2015"], *this),
        im_h_00(p["B->K^*ll::Im{h_0^0}@CFFMPSV2015"], *this),
        re_h_01(p["B->K^*ll::Re{h_0^1}@CFFMPSV2015"], *this),
        im_h_01(p["B->K^*ll::Im{h_0^1}@CFFMPSV2015"], *this),
        re_h_02(p["B->K^*ll::Re{h_0^2}@CFFMPSV2015"], *this),
        im_h_02(p["B->K^*ll::Im{h_0^2}@CFFMPSV2015"], *this),
        re_h_p0(p["B->K^*ll::Re{h_p^0}@CFFMPSV2015"], *this),
        im_h_p0(p["B->K^*ll::Im{h_p^0}@CFFMPSV2015"], *this),
        re_h_p1(p["B->K^*ll::Re{h_p^1}@CFFMPSV2015"], *this),
        im_h_p1(p["B->K^*ll::Im{h_p^1}@CFFMPSV2015"], *this),
        re_h_p2(p["B->K^*ll::Re{h_p^2}@CFFMPSV2015"], *this),
        im_h_p2(p["B->K^*ll::Im{h_p^2}@CFFMPSV2015"], *this),
        re_h_m0(p["B->K^*ll::Re{h_m^0}@CFFMPSV2015"], *this),
        im_h_m0(p["B->K^*ll::Im{h_m^0}@CFFMPSV2015"], *this),
        re_h_m1(p["B->K^*ll::Re{h_m^1}@CFFMPSV2015"], *this),
        im_h_m1(p["B->K^*ll::Im{h_m^1}@CFFMPSV2015"], *this),
        re_h_m2(p["B->K^*ll::Re{h_m^2}@CFFMPSV2015"], *this),
        im_h_m2(p["B->K^*ll::Im{h_m^2}@CFFMPSV2015"], *this),
        // parameters for [CFFMPSV2015] for polar coordinates
        abs_h_00(p["B->K^*ll::Abs{h_0^0}@CFFMPSV2015"], *this),
        arg_h_00(p["B->K^*ll::Arg{h_0^0}@CFFMPSV2015"], *this),
        abs_h_01(p["B->K^*ll::Abs{h_0^1}@CFFMPSV2015"], *this),
        arg_h_01(p["B->K^*ll::Arg{h_0^1}@CFFMPSV2015"], *this),
        abs_h_02(p["B->K^*ll::Abs{h_0^2}@CFFMPSV2015"], *this),
        arg_h_02(p["B->K^*ll::Arg{h_0^2}@CFFMPSV2015"], *this),
        abs_h_p0(p["B->K^*ll::Abs{h_p^0}@CFFMPSV2015"], *this),
        arg_h_p0(p["B->K^*ll::Arg{h_p^0}@CFFMPSV2015"], *this),
        abs_h_p1(p["B->K^*ll::Abs{h_p^1}@CFFMPSV2015"], *this),
        arg_h_p1(p["B->K^*ll::Arg{h_p^1}@CFFMPSV2015"], *this),
        abs_h_p2(p["B->K^*ll::Abs{h_p^2}@CFFMPSV2015"], *this),
        arg_h_p2(p["B->K^*ll::Arg{h_p^2}@CFFMPSV2015"], *this),
        abs_h_m0(p["B->K^*ll::Abs{h_m^0}@CFFMPSV2015"], *this),
        arg_h_m0(p["B->K^*ll::Arg{h_m^0}@CFFMPSV2015"], *this),
        abs_h_m1(p["B->K^*ll::Abs{h_m^1}@CFFMPSV2015"], *this),
        arg_h_m1(p["B->K^*ll::Arg{h_m^1}@CFFMPSV2015"], *this),
        abs_h_m2(p["B->K^*ll::Abs{h_m^2}@CFFMPSV2015"], *this),
        arg_h_m2(p["B->K^*ll::Arg{h_m^2}@CFFMPSV2015"], *this),
        e_q(-1.0/3.0)
    {
        ...
        std::string mode = o.get("mode", "cartesian");
        if ("cartesian" == mode)
        {
            h_0 = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_0_cartesian, this, std::placeholders::_1);
            h_p = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_p_cartesian, this, std::placeholders::_1);
            h_m = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_m_cartesian, this, std::placeholders::_1);
        }
        else if ("polar" == mode)
        {
            h_0 = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_0_polar, this, std::placeholders::_1);
            h_p = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_p_polar, this, std::placeholders::_1);
            h_m = std::bind(&BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_m_polar, this, std::placeholders::_1);
        }
        else
        {
            throw InvalidOptionValueError("mode", mode, "cartesian, polar");
        }
    ...
    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_0_cartesian(const double & s) const
    {
        return std::complex<double>(re_h_00 + s * re_h_01 + s * s * re_h_02, im_h_00 + s * im_h_01 + s * s * im_h_02);
    }

    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_p_cartesian(const double & s) const
    {
        return std::complex<double>(re_h_p0 + s * re_h_p1 + s * s * re_h_p2, im_h_p0 + s * im_h_p1 + s * s * im_h_p2);
    }

    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_m_cartesian(const double & s) const
    {
        return std::complex<double>(re_h_m0 + s * re_h_m1 + s * s * re_h_m2, im_h_m0 + s * im_h_m1 + s * s * im_h_m2);
    }

    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_0_polar(const double & s) const
    {
        return std::polar(abs_h_00(), arg_h_00()) + s * std::polar(abs_h_01(), arg_h_01()) + s * s * std::polar(abs_h_02(), arg_h_02());
    }

    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_p_polar(const double & s) const
    {
        return std::polar(abs_h_p0(), arg_h_p0()) + s * std::polar(abs_h_p1(), arg_h_p1()) + s * s * std::polar(abs_h_p2(), arg_h_p2());
    }

    complex<double>
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::h_m_polar(const double & s) const
    {
        return std::polar(abs_h_m0(), arg_h_m0()) + s * std::polar(abs_h_m1(), arg_h_m1()) + s * s * std::polar(abs_h_m2(), arg_h_m2());
    }
    ...
    BToKstarDileptonAmplitudes<tag::CFFMPSV2015>::amplitudes(const double & s) const
    {
        ...
        complex<double> h_0 = this->h_0(s);
        complex<double> h_p = this->h_p(s);
        complex<double> h_m = this->h_m(s);
