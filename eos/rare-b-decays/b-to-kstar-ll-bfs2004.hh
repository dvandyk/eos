...
namespace eos
{
    ...
    {
        public:
            using DipoleFormFactors = BToKstarDilepton::DipoleFormFactors;
            ...
            double m_b_PS() const;
            double mu_f() const;
            DipoleFormFactors dipole_form_factors(const double & q2, const WilsonCoefficients<BToS> & wc) const;
