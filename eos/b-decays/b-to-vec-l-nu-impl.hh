...
namespace eos
{
    ...
    {
        private:
            b_to_vec_l_nu::AngularObservables _ao;
            b_to_vec_l_nu::AngularObservables _ao_bar;

        public:
            friend class BToVectorLeptonNeutrino;
            friend class Implementation<BToVectorLeptonNeutrino>;

            IntermediateResult(const b_to_vec_l_nu::AngularObservables & ao, const b_to_vec_l_nu::AngularObservables & ao_bar) :
                _ao(ao),
                _ao_bar(ao_bar)
            {
            }
