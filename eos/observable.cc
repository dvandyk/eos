...
namespace eos
{
    ...
    make_observable_entries()
    {
        static const std::map<QualifiedName, const ObservableEntry *> observable_entries
        {
            ...
            // Lambda_b -> Lambda_c Form Factors
            make_form_factor_adapter("Lambda_b->Lambda_c::f_time^V(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_time_v, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_long^V(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_long_v, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_perp^V(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_perp_v, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_time^A(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_time_a, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_long^A(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_long_a, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_perp^A(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_perp_a, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_long^T(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_long_t, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_perp^T(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_perp_t, std::make_tuple("s")),
            make_form_factor_adapter("Lambda_b->Lambda_c::f_long^T5(s)", "Lambda_b->Lambda_c",
                                     &FormFactors<OneHalfPlusToOneHalfPlus>::f_long_t5, std::make_tuple("s")),
