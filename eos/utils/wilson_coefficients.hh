...
namespace eos
{
    ...
    {
        /*
         * Assuming only left-handed neutrinos, only to operators exist beyond the SM.
         * These two operators are defined via
         *
         * H^eff = 4 G_F / sqrt(2) V_tb V_ts^* (
         *             C_L [sbar gamma^mu P_L b] [nubar gamma_mu P_L nu]
         *             C_R [sbar gamma^mu P_R b] [nubar gamma_mu P_L nu]
         *         )
