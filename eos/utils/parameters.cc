...
namespace eos
{
    ...
    Parameters::Defaults()
    {
        return Parameters(new Implementation<Parameters>({
            ...
            // b->d Wilson coefficients C1 - C6 at mu = 4.2 GeV to NNLL accuary as calculated in the SM by EOS's StandardModel class.
            // For the calculations, cf. [BMU1999].
            Parameter::Template{"b->d::c1",                                      -0.29063621,     -0.29063621,     -0.29063621    },
            Parameter::Template{"b->d::c2",                                      +1.01029623,     +1.01029623,     +1.01029623    },
            Parameter::Template{"b->d::c3",                                      -0.00616220,     -0.00616220,     -0.00616220    },
            Parameter::Template{"b->d::c4",                                      -0.08730376,     -0.08730376,     -0.08730376    },
            Parameter::Template{"b->d::c5",                                      +0.00042854,     +0.00042854,     +0.00042854    },
            Parameter::Template{"b->d::c6",                                      +0.00115807,     +0.00115807,     +0.00115807    },
            Parameter::Template{"b->d::Re{c7}",                                  -1.0,            -0.33726473,     +1.0           },
            Parameter::Template{"b->d::Im{c7}",                                  -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->d::c8",                                      -0.18288898,     -0.18288898,     -0.18288898    },
            Parameter::Template{"b->dee::Re{c9}",                               -15.0,            +4.27342842,    +15.0           },
            Parameter::Template{"b->dee::Im{c9}",                               -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dee::Re{c10}",                              -15.0,            -4.16611761,    +15.0           },
            Parameter::Template{"b->dee::Im{c10}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Re{c9}",                             -15.0,            +4.27342842,    +15.0           },
            Parameter::Template{"b->dmumu::Im{c9}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Re{c10}",                            -15.0,            -4.16611761,    +15.0           },
            Parameter::Template{"b->dmumu::Im{c10}",                            -15.0,            +0.0,           +15.0           },
            // Primed Wilson coefficients are negligible in the SM
            Parameter::Template{"b->d::Re{c7'}",                                 -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->d::Im{c7'}",                                 -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->d::c8'",                                     +0.0,            +0.0,            +0.0           },
            Parameter::Template{"b->dee::Re{c9'}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dee::Im{c9'}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dee::Re{c10'}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dee::Im{c10'}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Re{c9'}",                            -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Im{c9'}",                            -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Re{c10'}",                           -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->dmumu::Im{c10'}",                           -15.0,            +0.0,           +15.0           },
            // scalar, pseudoscalar, and tensor b -> s ll coefficients
            Parameter::Template{"b->dee::Re{cS}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cS}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Re{cS'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cS'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Re{cP}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cP}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Re{cP'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cP'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Re{cT}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cT}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Re{cT5}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dee::Im{cT5}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cS}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cS}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cS'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cS'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cP}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cP}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cP'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cP'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cT}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cT}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Re{cT5}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->dmumu::Im{cT5}",                             -1.0,            +0.0,            +1.0           },
            // b->s Wilson coefficients C1 - C6 at mu = 4.2 GeV to NNLL accuary as calculated in the SM by EOS's StandardModel class.
            // For the calculations, cf. [BMU1999].
            Parameter::Template{"b->s::c1",                                      -0.29063621,     -0.29063621,     -0.29063621    },
            Parameter::Template{"b->s::c2",                                      +1.01029623,     +1.01029623,     +1.01029623    },
            Parameter::Template{"b->s::c3",                                      -0.00616220,     -0.00616220,     -0.00616220    },
            Parameter::Template{"b->s::c4",                                      -0.08730376,     -0.08730376,     -0.08730376    },
            Parameter::Template{"b->s::c5",                                      +0.00042854,     +0.00042854,     +0.00042854    },
            Parameter::Template{"b->s::c6",                                      +0.00115807,     +0.00115807,     +0.00115807    },
            Parameter::Template{"b->s::Re{c7}",                                  -1.0,            -0.33726473,     +1.0           },
            Parameter::Template{"b->s::Im{c7}",                                  -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->s::c8",                                      -0.18288898,     -0.18288898,     -0.18288898    },
            Parameter::Template{"b->see::Re{c9}",                               -15.0,            +4.27342842,    +15.0           },
            Parameter::Template{"b->see::Im{c9}",                               -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->see::Re{c10}",                              -15.0,            -4.16611761,    +15.0           },
            Parameter::Template{"b->see::Im{c10}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Re{c9}",                             -15.0,            +4.27342842,    +15.0           },
            Parameter::Template{"b->smumu::Im{c9}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Re{c10}",                            -15.0,            -4.16611761,    +15.0           },
            Parameter::Template{"b->smumu::Im{c10}",                            -15.0,            +0.0,           +15.0           },
            // Primed Wilson coefficients are negligible in the SM
            Parameter::Template{"b->s::Re{c7'}",                                 -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->s::Im{c7'}",                                 -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->s::c8'",                                     +0.0,            +0.0,            +0.0           },
            Parameter::Template{"b->see::Re{c9'}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->see::Im{c9'}",                              -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->see::Re{c10'}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->see::Im{c10'}",                             -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Re{c9'}",                            -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Im{c9'}",                            -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Re{c10'}",                           -15.0,            +0.0,           +15.0           },
            Parameter::Template{"b->smumu::Im{c10'}",                           -15.0,            +0.0,           +15.0           },
            // scalar, pseudoscalar, and tensor b -> s ll coefficients
            Parameter::Template{"b->see::Re{cS}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cS}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Re{cS'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cS'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Re{cP}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cP}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Re{cP'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cP'}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Re{cT}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cT}",                                -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Re{cT5}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->see::Im{cT5}",                               -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cS}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cS}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cS'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cS'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cP}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cP}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cP'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cP'}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cT}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cT}",                              -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Re{cT5}",                             -1.0,            +0.0,            +1.0           },
            Parameter::Template{"b->smumu::Im{cT5}",                             -1.0,            +0.0,            +1.0           },
            // b->u Wilson coefficients
            Parameter::Template{"b->ulnu::Re{cVL}",                               1.0,             1.0,             1.0           },
            Parameter::Template{"b->ulnu::Im{cVL}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Re{cVR}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Im{cVR}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Re{cSL}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Im{cSL}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Re{cSR}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Im{cSR}",                               0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Re{cT}",                                0.0,             0.0,             0.0           },
            Parameter::Template{"b->ulnu::Im{cT}",                                0.0,             0.0,             0.0           },
            // Factorization scale
            ...
            Parameter::Template{"Lambda_b->Lambda_b::rho_D^3@1GeV",              +0.09,           +0.17,           +0.25          }, // cf. [MvD2015]
