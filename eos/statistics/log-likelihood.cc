...
/*
 * Copyright (c) 2011, 2013, 2014, 2015, 2016 Danny van Dyk
...
namespace eos
{
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<5>(ObservableCache cache, const std::array<ObservablePtr, 5> & observables,
                                             const std::array<double, 5> & mean, const std::array<std::array<double, 5>, 5> & covariance,
                                             const unsigned & number_of_observations = 5u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<7>(ObservableCache cache, const std::array<ObservablePtr, 7> & observables,
                                             const std::array<double, 7> & mean, const std::array<std::array<double, 7>, 7> & covariance,
                                             const unsigned & number_of_observations = 7u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<8>(ObservableCache cache, const std::array<ObservablePtr, 8> & observables,
                                             const std::array<double, 8> & mean, const std::array<std::array<double, 8>, 8> & covariance,
                                             const unsigned & number_of_observations = 8u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<11>(ObservableCache cache, const std::array<ObservablePtr, 11> & observables,
                                             const std::array<double, 11> & mean, const std::array<std::array<double, 11>, 11> & covariance,
                                             const unsigned & number_of_observations = 11u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<12>(ObservableCache cache, const std::array<ObservablePtr, 12> & observables,
                                             const std::array<double, 12> & mean, const std::array<std::array<double, 12>, 12> & covariance,
                                             const unsigned & number_of_observations = 12u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<19>(ObservableCache cache, const std::array<ObservablePtr, 19> & observables,
                                             const std::array<double, 19> & mean, const std::array<std::array<double, 19>, 19> & covariance,
                                             const unsigned & number_of_observations = 19u);
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<48>(ObservableCache cache, const std::array<ObservablePtr, 48> & observables,
                                             const std::array<double, 48> & mean, const std::array<std::array<double, 48>, 48> & covariance,
    ...
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<4>(ObservableCache cache, const std::array<ObservablePtr, 4> & observables,
                                             ...
                                             const unsigned & number_of_observations = 4u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<5>(ObservableCache cache, const std::array<ObservablePtr, 5> & observables,
                                             const std::array<double, 5> & mean, const std::array<double, 5> & variances,
                                             const std::array<std::array<double, 5>, 5> & correlation,
                                             const unsigned & number_of_observations = 5u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<6>(ObservableCache cache, const std::array<ObservablePtr, 6> & observables,
                                             ...
                                             const unsigned & number_of_observations = 6u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<7>(ObservableCache cache, const std::array<ObservablePtr, 7> & observables,
                                             const std::array<double, 7> & mean, const std::array<double, 7> & variances,
                                             const std::array<std::array<double, 7>, 7> & correlation,
                                             const unsigned & number_of_observations = 7u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<8>(ObservableCache cache, const std::array<ObservablePtr, 8> & observables,
                                             const std::array<double, 8> & mean, const std::array<double, 8> & variances,
                                             const std::array<std::array<double, 8>, 8> & correlation,
                                             const unsigned & number_of_observations = 8u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<11>(ObservableCache cache, const std::array<ObservablePtr, 11> & observables,
                                             const std::array<double, 11> & mean, const std::array<double, 11> & variances,
                                             const std::array<std::array<double, 11>, 11> & correlation,
                                             const unsigned & number_of_observations = 11u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<12>(ObservableCache cache, const std::array<ObservablePtr, 12> & observables,
                                             const std::array<double, 12> & mean, const std::array<double, 12> & variances,
                                             const std::array<std::array<double, 12>, 12> & correlation,
                                             const unsigned & number_of_observations = 12u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<16>(ObservableCache cache, const std::array<ObservablePtr, 16> & observables,
                                             ...
                                             const unsigned & number_of_observations = 16u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<19>(ObservableCache cache, const std::array<ObservablePtr, 19> & observables,
                                             const std::array<double, 19> & mean, const std::array<double, 19> & variances,
                                             const std::array<std::array<double, 19>, 19> & correlation,
                                             const unsigned & number_of_observations = 19u);
    template LogLikelihoodBlockPtr LogLikelihoodBlock::MultivariateGaussian<22>(ObservableCache cache, const std::array<ObservablePtr, 22> & observables,
